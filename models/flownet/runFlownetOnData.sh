...
declare -a OBJECTS=("ragdoll_one_cw" "wooden_case_one_cw" "dumpster_one_cw")
...
do 
	...
	rm -rf /esat/qayd/kkelchte/simulation/$DATASET/${object}/flownets/*.txt

done

echo "flownet calculation" | mailx -s "${OBJECTS[@]} of $DATASET flownets are calculated" klaas.kelchtermans@esat.kuleuven.be
