...
if len(sys.argv)-1 != 2:
    print("Use this tool to test FlowNet on images\n"
          ...
          "    ./demo_flownets.py IMAGE1 IMAGE2\n"
          "\n"
          "Usage for a pair of image lists (must end with .txt):\n"
          "    ./demo_flownets.py LIST1.TXT LIST2.TXT\n")
    sys.exit(1)
...
# Prepare prototxt: copy images to same tmp location in same img1.txt format
...
divisor = 64.
adapted_width = ceil(width/divisor) * divisor # Adapt width for convnet
